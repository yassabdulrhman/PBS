...
$(function () {
  ...
  function initializeCharts() {
    ...
    $(".d3-*").empty();
    Morris.Line({
      colors: ["#E67A77", "#C4F11D", "#79D1CF", "#2418ab"],
      element: "lineChart",
      data: [{
        year: "2008",
        value: 45,
    ...
    Morris.Bar({
      ...
      xkey: "label",
      ykeys: ["value"],
      barColors: ["#C4F11D", "#79D1CF", "#2418ab"],
...
function getDonutData(group, column) {
  ...
  var result = _.chain(getChartData()).groupBy(group).map(function (value, key) {
    return {
      label: key,
...
module.exports = __webpack_require__(/*! /Applications/XAMPP/xamppfiles/htdocs/Github/PBS/resources/js/chart.js */"./resources/js/chart.js");
